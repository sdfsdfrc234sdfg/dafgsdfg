package com.world_compL.lv.ui.main_scr;
...
import com.world_compL.lv.dbNet.database.UserDao;
import com.world_compL.lv.databinding.FragmentOwnProfileBinding;
...
public class ProfileFragment extends Fragment {
    ...
    private UserDao userDao = MyApplication.getInstance().getDatabase().userDao();
